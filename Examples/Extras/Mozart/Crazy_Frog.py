...
from picobricks import SSD1306_I2C,NeoPixel
import framebuf
import random               #random, neopixelin rastgele çalışmasını sağlıyor.
from images import bar_0, bar_20, bar_50, bar_70, bar_90, bar_100, maskot_1, maskot_2, maskot_3, maskot_4 #imgs, kütüphanesini çalıştırıyoruz ve görselleri kütüphaneden kullanıyoruz.
...
time.sleep(1)
#if sugar_position == 0:
#                     oled.blit(sugar1, 0, 0)
#                     sugar_position = 1
#                     led.high()
#                 else:
#                     oled.blit(sugar2, 0, 0)
#                     sugar_position = 0
#                     led.low()
#                 oled.show()
...
neo = NeoPixel(6, n=41, brightness=0.4, autowrite=False)
...
def play(melody,tempo,pause,pace=0.7):
    ...
    for i in range(0, len(melody)): # Play song
        ...
        neo.fill((random.randint(0,255), random.randint(0,255), random.randint(0,255)))
        neo.show()
